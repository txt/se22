...
- **<u>HW2</u>**: get this going for the `Num` and `Sym` class (below) and the tests cases
  `the`, `sym`, `num`, `bignum`.
- **<u>HW3</u>**: get this going for the `Cols`, `Row`, `Data` class and the test cases
  `eg.csv, eg.data, eg.stats`
- **<u>HW4</u>**: add all the bling from HW1. Also, add post-commit hooks to auto run all the test cases, the code
...
- **<u>HW5</u>**: for five other groups from cs510 (picked at random), apply the Project1 
